  ...
  <div class="mb-5">
    ...
    <div v-for="(ayat, index) in arrayAyat" :key="index" class="card">
      <div class="card-body text-end">
        ...
        <h5 class="card-title nomorAyat d-inline display-5 align-center">{{ ayat.text_uthmani_simple }}</h5>
        <br />
        <div class="mt-3">
...
export default {
  ...
  methods: {
    ...
    getAyat() {
      axios
        .get(`https://api.quran.com/api/v4/quran/verses/uthmani_simple?chapter_number=${this.$route.params.id}`)
        .then((response) => {
