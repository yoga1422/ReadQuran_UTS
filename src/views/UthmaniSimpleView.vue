  ...
  <main>
    <div class="jumbotron jumbotron-fluid">
      <div class="container text-center">
        <h1 class="mt-5 display-4 fw-bolder">Uthmani Simple Mushaf</h1>
              ...
              <div class="card-body">
                <div class="media d-flex">
                  <div class="media-body m-auto text-center">
                    ...
                    <router-link :to="{ name: 'simple', params: { id: chapter.id } }" class="btn btn-outline-dark text-black">Read </router-link>
                  </div>
                </div>
              </div>
            </div>
